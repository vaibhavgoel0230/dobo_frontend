...
const CreatePin = ({ user }) => {
    ...
    return (
        <div className='flex flex-col justify-center items-center mt-5 lg:h-4/5'>
            ...
            <div className='flex lg:flex-row flex-col justify-center items-center bg-white lg:-5 p-3 lg:w-4/5 w-full'>
                ...
                <div className='flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full'>
                    <input type="text" value={title} onChange={(e) => setTitle(e.target.value)}
                        placeholder='Add your title here' className='outline-none text-2xl sm:text-3xl font-bold border-b-2 border-gray-200 p-2' />
                    {user && (
                    ...
                    <input type="text" value={about} onChange={(e) => setAbout(e.target.value)}
                        placeholder='What is your pin about' className='outline-none text-base sm:text-lg border-b-2 border-gray-200 p-2' />
