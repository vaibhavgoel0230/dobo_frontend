...
const PinDetail = ({ user }) => {
    ...
    const addComment = () => {
        if (comment) {
            ...
            client.patch(pinId).setIfMissing({ comments: [] }).insert(
                'after', 'comments[-1]', [{
                    comment,
                    _key: uuidv4(),
                    postedBy: {
            ...
            <div className='flex xl:flex-row flex-col m-auto bg-white' style={{ maxWidth: '1500px', borderRadius: '32px' }}>
                ...
                <div className='w-full p-5 flex-1 xl:min-w-620'>
                    <div className='flex items-center justify-between'>
                        ...
                        <a href={pinDetail.destination} target='_blank' rel='referrer'>
                    ...
                    <div className='flex flex-wrap mt-6 gap-3'>
                        ...
                        <input className='flex-1 border-gray-100 outline-none border-2 p-2 rounded-2-xl focus:border-gray-100' type="text" placeholder='Add a comment' value={comment} onChange={(e) => setComment(e.target.value)} />
